...
import com.example.restoranpizza.Menus
import com.example.restoranpizza.pagemenu.Companion.INTENT_PARCELABLE
...
class DetailMenu : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedMenu = intent?.getParcelableExtra<Menus>(INTENT_PARCELABLE)
